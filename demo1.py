...
# pStarDerRecrod = np.zeros([order, bezier.dimension])
# for j in range(order):
#     i = j + 1
#     wDerRecord[j, 0] = BezierKit.bernstein.wDer(bezier.weights, bezier.p, u, i)
#     pStarDerRecrod[j, :] = BezierKit.bernstein.pStarDer(bezier.weights, bezier.ctrlpts, bezier.p, u, i)
#
